---
title: "R Workshop"
subtitle: "Module 6: \"To Infinity and Beyond\" (2)"
...
```{r echo=FALSE, out.width="80%", out.extra='style="display: block; margin: auto; margin-top: 5%; box-shadow: none;"'}
...
include_graphics("https://media0.giphy.com/media/12mPcp41D9a1i0/giphy.gif")
```
<p style="font-size:0.5em; text-align:center; color: #777;">
...
## Now let's get to it!
```{r echo=FALSE, out.width="40%", out.extra='style="display: block; margin: auto; box-shadow: none;"'}
include_graphics("https://media1.giphy.com/media/JIX9t2j0ZTN9S/giphy.gif")
```
<p style="font-size:0.5em; text-align:center; color: #777;">
...
##
```{r echo=FALSE, out.width="80%", out.extra='style="display: block; margin: auto; box-shadow: none;"'}
include_graphics("https://media.giphy.com/media/ehfWmij1MrqjS/giphy.gif")
```
<p style="font-size:0.5em; text-align:center; color: #777;">

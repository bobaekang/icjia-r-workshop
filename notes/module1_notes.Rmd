...
1. Sterling finds out that he needs Uniform Crime Reports (UCR) data from Illinois State Police (ISP) website for his project. In fact, he needs data for the five most recent years He goes to the website and download each file separately, which lands on the default Download folder.
2. Sterling browses to the Download folder and opens the files in MS Excel:
...
4. Sterling so goes back to the Download folder for the original files, spends some minutes to find the downloaded files (there are so many files in the Download folder!), opens all spreadsheets in Excel, and copy-and-pastes the desired column from them to the combined spreadsheet. He saves it as a separate file (`mydata2.xlsx`).
...
### Reproducibiltiy
A high degree of reproducibility of analysis can also greatly enhance productivity in a collaborative project.

...
* License cost (DUH!)
    * At the time of writing, the Professional Edition of Tableau Desktop software costs $70 per user per month. Also, to store data sources and workbooks securely, an additional cost of $35 per user per month for Tableau Server must be paid.[^2] **R is free.**
* Cleaning data
* Complex and advanced analysis

[^2]: See the official Tableau [Pricing page](https://www.tableau.com/pricing) for more information.

This is not to say that all these softwares are useless. Each software is designed with a specific purpose, and any of them probably has a better learning curve compared to R. Nonetheless, ...

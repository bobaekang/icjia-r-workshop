...
* Watch the package author's presentation [video](https://www.rstudio.com/resources/videos/infer-a-package-for-tidy-statistical-inference/)
* Visit the package [website](http://infer.netlify.com/index.html) to learn more about it

```{r echo=FALSE, out.width="750%", out.extra='style="display: block; margin: auto; box-shadow: none;"'}
include_graphics("../images/infer.png")
```
<p style="font-size:0.5em; text-align:center; color: #777;">
Source: <a href="http://infer.netlify.com/index.html">infer package website</a>
</p>
...
We can read [this Wikipedia article](https://en.wikipedia.org/wiki/Maximum_likelihood_estimation) for more on maximum likelihood estimation.
...
Visit `broom` [GitHub repository](https://github.com/tidyverse/broom) and "`broom` as well as `dplyr`" [vignette](https://cran.r-project.org/web/packages/broom/vignettes/broom_and_dplyr.html) to learn more about the package.
...
You can visit `modelr` [GitHub repository](https://github.com/tidyverse/modelr) or read the ["Model Basics" chapter](http://r4ds.had.co.nz/model-basics.html) in *R for Data Science* to learn more about the package.

...
This page contains the notes for **the first part of R Workshop Module 6: Sharing your analysis and more**, which is part of the R Workshop series prepared by ICJIA Research Analyst [Bobae Kang](http://www.icjia.state.il.us/biographies/bobae-kang) to enable and encourage ICJIA researchers to take advantage of R, a statistical programming language that is one of the most powerful modern research tools.
...
Click [**here**](../slides/module6_slides1.html) to view the accompanying **slides for Module 6, Part 1**.
...
# Sharing your analysis and more (1):

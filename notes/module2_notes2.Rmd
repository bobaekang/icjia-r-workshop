...
Now that we have an understanding of the basic building blocks of R programming, we can prepare for conducting data analysis in R. Here we will learn to work with R data frame, the essense of tabular data manipulation in R. We will than be introduced to the `tidyverse` framework and the idea of "tidy" data. Finally, we will discuss some recommended coding style for R.

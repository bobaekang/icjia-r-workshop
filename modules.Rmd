...
<br>
(Note: Currently, slides and notes for only the first four modules are ready for use. Materials for later modules are in active development and scheduled to be completed by the end of March. Thank you for your understanding!)
...
* [**Notes**](./notes/module2_notes2.html)
</div>
</div>
</div>
</div>
...
* [**Notes**](./notes/module5_notes1.html) (in development)

### Part 2: Options for advanced modeling

* [**Slides**](./slides/module5_slides2.html) (in development)
* [**Notes**](./notes/module5_notes2.html) (in development)
</div>
</div>
</div>
</div>
...
* [**Notes**](./notes/module6_notes1.html) (in development)

### Part 2: Leveraging online resources

* [**Slides**](./slides/module6_slides2.html) (in development)
* [**Notes**](./notes/module6_notes2.html) (in development)
</div>
</div>
</div>
</div>
